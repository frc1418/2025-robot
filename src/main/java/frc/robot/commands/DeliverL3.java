...
public class DeliverL3 extends SequentialCommandGroup {
    public DeliverL3(PivotSubsystem pivotSubsystem, ElevatorSubsystem elevatorSubsystem, IntakeSubsystem intakeSubsystem, RobotBase robot) {
    addCommands(
      Commands.deadline(
        Commands.waitSeconds(2), 
        pivotSubsystem.setPivot(65),
        elevatorSubsystem.moveElevatorToHeight(0.75)),
      Commands.deadline(
