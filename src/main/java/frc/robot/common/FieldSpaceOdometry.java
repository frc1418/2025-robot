...
public class FieldSpaceOdometry {
  ...
  AprilTagFieldLayout tagLocations = AprilTagFieldLayout.loadField(AprilTagFields.k2025ReefscapeAndyMark);
  ...
  public Optional<Pose3d> getClosestAprilTagPose() {
    return tagLocations.getTagPose(getAprilTagNumber());
  }
